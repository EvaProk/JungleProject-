...
RSpec.describe User, type: :model do
  before(:each) do 
    @user=User.create(first_name: "Eva",last_name: "Prokhorenko", email: "test1@gmail.com", password: "12345", password_confirmation: "12345")
  end
  describe 'Validations' do
    ...
    context "Email checking" do 
      ...
      it 'should have unique emails, not case sensitive' do
        @user.save
        @user2 = User.create(first_name: "Eva",last_name: "Prokhorenko", email: "test1@gmail.COM", password: "12345", password_confirmation: "12345")
        @user2.save        
